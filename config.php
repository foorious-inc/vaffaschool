<?php
define('SCHOOLS_RAW_DATA_DIR', __DIR__ . '/data/raw/MIUR/2018/'); // location of raw data
...
define('SCHOOLS_DATA_SQLITE_FILE', __DIR__ . '/data/schools.sqlite'); // location of Sqlite DB file
