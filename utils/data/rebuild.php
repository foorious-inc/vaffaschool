...
EOF;
        ...
        $i=0;
        $i++; $stmt->bindParam($i, $school['id']);
        $i++; $stmt->bindParam($i, $school['ref_id']);
        $i++; $stmt->bindParam($i, $school['schoolyear']);
        $i++; $stmt->bindParam($i, $school['type']);
        $i++; $stmt->bindParam($i, $school['name']);
        $i++; $stmt->bindParam($i, $school['email']);
        $i++; $stmt->bindParam($i, $school['certified_email']);
        $i++; $stmt->bindParam($i, $school['website']);
        $i++; $stmt->bindParam($i, $school['address']);
        $i++; $stmt->bindParam($i, $school['cad_code']);
        $i++; $stmt->bindParam($i, $school['postcode']);
        $i++; $stmt->bindParam($i, $school['city_name']);
        $i++; $stmt->bindParam($i, $school['city_id']);
        $i++; $stmt->bindParam($i, $school['province_name']);
        $i++; $stmt->bindParam($i, $school['province_id']);
        $i++; $stmt->bindParam($i, $school['province_license_plate_code']);
        $i++; $stmt->bindParam($i, $school['region_name']);
        $i++; $stmt->bindParam($i, $school['region_id']);
        $i++; $stmt->bindParam($i, $school['nuts3_2010_code']);
        $i++; $stmt->bindParam($i, $group['id']);
        $i++; $stmt->bindParam($i, $group['ref_id']);
        $i++; $stmt->bindParam($i, $group['schoolyear']);
        $i++; $stmt->bindParam($i, $group['type']);
        $i++; $stmt->bindParam($i, $group['name']);
        $i++; $stmt->bindParam($i, $group['email']);
        $i++; $stmt->bindParam($i, $group['certified_email']);
        $i++; $stmt->bindParam($i, $group['website']);
        $i++; $stmt->bindParam($i, $group['address']);
        $i++; $stmt->bindParam($i, $group['cad_code']);
        $i++; $stmt->bindParam($i, $group['postcode']);
        $i++; $stmt->bindParam($i, $group['city_name']);
        $i++; $stmt->bindParam($i, $group['city_id']);
        $i++; $stmt->bindParam($i, $group['province_name']);
        $i++; $stmt->bindParam($i, $group['province_id']);
        $i++; $stmt->bindParam($i, $group['province_license_plate_code']);
        $i++; $stmt->bindParam($i, $group['region_name']);
        $i++; $stmt->bindParam($i, $group['region_id']);
        $i++; $stmt->bindParam($i, $group['nuts3_2010_code']);
